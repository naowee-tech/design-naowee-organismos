...
## Corpus Check
- 219 files · ~941,727 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7965 nodes · 21373 edges · 203 communities (171 shown, 32 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 534 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5f9a369a`
...
Cohesion: 0.07
Nodes (71): AFIL_ESTADO, AFIL_SOL_VARIANT, afilById(), badge(), capFirst(), closeModal(), cubiertoPorRolAnclado(), doApproveAfil() (+63 more)
...
Cohesion: 0.06
Nodes (65): comitePorSector(), advance(), ageHint(), applyMask(), bindPane(), checkDup(), choiceGroup(), clearFieldError() (+57 more)
...
Cohesion: 0.08
Nodes (55): advance(), ageHint(), applyMask(), bindPane(), checkDup(), choiceGroup(), clearFieldError(), dd() (+47 more)
...
Cohesion: 0.14
Nodes (38): doApprove(), seedCarguesDemo(), addOrganismo(), addOrganismosBulk(), allAudit(), allCargues(), allPreinscritos(), auditLog() (+30 more)
...
Cohesion: 0.14
Nodes (25): bindDemoSwitcher(), bindHeaderEvents(), bindSidebarEvents(), closeDrawer(), demoToast(), flashPlaceholder(), getDemoMode(), getIcon() (+17 more)
...
Cohesion: 0.17
Nodes (16): bandejaOrgs(), anio(), buildDeportistaDetalle(), DEPORTE_EMOJI, DOC_LABEL, fmtFecha(), MESES, PERFIL_EXTRA (+8 more)
...
Cohesion: 0.13
Nodes (41): seedCarguesDemo(), addOrganismo(), allAudit(), allCargues(), allDeportistas(), allOrganismos(), applyOverride(), auditLog() (+33 more)
...
Cohesion: 0.12
Nodes (41): seedBandejaDemo(), seedCarguesDemo(), addOrganismo(), allAudit(), allCargues(), allOrganismos(), applyOverride(), auditLog() (+33 more)
...
## Knowledge Gaps
- **1866 isolated node(s):** `I`, `TIER`, `MEDAL_EMOJI`, `DEPORTE_EMOJI`, `SOL_EMOJI` (+1861 more)
...
- **Why does `allOrganismos()` connect `organismos-data.js` to `deportista-detalle.js`, `detalle.js`, `registro.js`, `bandeja.js`, `cargue.js`, `afiliacion.js`, `registro-publico.js`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `getOrganismo()` connect `bandeja.js` to `detalle.js`, `organismos-data.js`, `cargue.js`, `estados.js`, `deportista-detalle.js`, `afiliacion.js`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
